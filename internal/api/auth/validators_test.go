	...
	*/
	...
	Convey("Given a set of test users, applications and nodes", t, func() {
		...
		Convey("When testing ValidateUsersAccess", func() {
			tests := []validatorTest{
				{
					Name:       "global admin user has access to create",
					Validators: []ValidatorFunc{ValidateUsersAccess(Create)},
					Claims:     Claims{Username: "user1"},
					ExpectedOK: true,
				},
				{
					Name:       "global admin user has access to list",
					Validators: []ValidatorFunc{ValidateUsersAccess(List)},
					Claims:     Claims{Username: "user1"},
					ExpectedOK: true,
				},
				{
					Name:       "inactive global admin user has no access to create",
					Validators: []ValidatorFunc{ValidateUsersAccess(Create)},
					Claims:     Claims{Username: "user8"},
					ExpectedOK: false,
				},
				{
					Name:       "inactive global admin user has no access to list",
					Validators: []ValidatorFunc{ValidateUsersAccess(List)},
					Claims:     Claims{Username: "user8"},
					ExpectedOK: false,
				},
				{
					Name:       "application admin user has access to create",
					Validators: []ValidatorFunc{ValidateUsersAccess(Create)},
					Claims:     Claims{Username: "user2"},
					ExpectedOK: true,
				},
				{
					Name:       "application admin user has access to list",
					Validators: []ValidatorFunc{ValidateUsersAccess(List)},
					Claims:     Claims{Username: "user2"},
					ExpectedOK: true,
				},
				{
					Name:       "normal user has no access to create",
					Validators: []ValidatorFunc{ValidateUsersAccess(Create)},
					Claims:     Claims{Username: "user2"},
					ExpectedOK: true,
				},
				...
				{
					Name:       "normal user has no access to list",
					Validators: []ValidatorFunc{ValidateUsersAccess(List)},
					Claims:     Claims{Username: "user4"},
					ExpectedOK: false,
				},
		...
		Convey("When testing ValidateUserAccess", func() {
			tests := []validatorTest{
				{
					Name:       "global admin user has access to read",
				...
				{
					Name:       "other users are not able to read",
					Validators: []ValidatorFunc{ValidateUserAccess(4, Read)},
					Claims:     Claims{Username: "user2"},
					ExpectedOK: false,
				},
				{
					Name:       "global admin user has access to update",
					Validators: []ValidatorFunc{ValidateUserAccess(4, Update)},
					Claims:     Claims{Username: "user1"},
					ExpectedOK: true,
				},
				{
					Name:       "user itself has no access to update",
					Validators: []ValidatorFunc{ValidateUserAccess(4, Update)},
					Claims:     Claims{Username: "user4"},
					ExpectedOK: false,
				},
				{
					Name:       "other users are not able to update",
					Validators: []ValidatorFunc{ValidateUserAccess(4, Update)},
					Claims:     Claims{Username: "user2"},
					ExpectedOK: false,
				},
		...
		Convey("When testing ValidateApplicationsAccess", func() {
			tests := []validatorTest{
				...
				{
					Name:       "inactive users do not have access to list",
					Validators: []ValidatorFunc{ValidateApplicationsAccess(List)},
